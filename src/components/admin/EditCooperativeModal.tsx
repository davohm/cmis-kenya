import { X, Building2, FileText, MapPin, Mail, Phone, Users, DollarSign, Calendar, Hash } from 'lucide-react';
...
export default function EditCooperativeModal({
  isOpen,
  onClose,
  cooperative,
  onSuccess
}: EditCooperativeModalProps) {
  const { updateCooperative, loadCooperativeTypes, loadCounties, loading } = useCooperativeCRUD();
    ...
    if (isOpen) {
      ...
      if (cooperative) {
        setFormData({
          ...
          type_id: cooperative.type_id || '',
          tenant_id: cooperative.tenant_id,
          registration_date: cooperative.registration_date || '',
          address: cooperative.address || '',
          postal_address: cooperative.postal_address || '',
          email: cooperative.email || '',
          phone: cooperative.phone || '',
          total_members: cooperative.total_members || 0,
          total_share_capital: cooperative.total_share_capital || 0
        });
      }
      setSuccessMessage('');
      setErrorMessage('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(`Successfully updated cooperative: ${formData.name}`);
      ...
      setErrorMessage(err instanceof Error ? err.message : 'Failed to update cooperative');
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-red-600 to-red-700">
          <div>
            <h2 className="text-2xl font-bold text-white">Edit Cooperative</h2>
            <p className="text-red-100 text-sm mt-1">Update cooperative information</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          <div className="flex space-x-3 mt-6">
            ...
            >
              {loading ? 'Updating...' : 'Update Cooperative'}
            </button>
          </div>
        </form>
      </div>
